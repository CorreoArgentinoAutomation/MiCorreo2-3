...
Feature: TE - Nuevo envio individual
  ...
  Scenario Outline: Nuevo envio individual
    ...
    Examples:
      ...
      | usuario ED  | SucursalZona1 | 1kg  | SucursalZona1 | Clasico      | Tarjeta      |
      | usuario ED  | SucursalZona1 | 1kg  | SucursalZona1 | Expreso      | Mercado Pago |
      | usuario ED  | SucursalZona1 | 1kg  | SucursalZona1 | Clasico      | Saldo        |
